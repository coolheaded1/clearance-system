<?php
  ...
  if(isset($_POST['createBtn'])) {
    ...
    $sel = $conn->query("SELECT * FROM `faculty` WHERE faculty_name = '$faculty'");
    if($sel->num_rows > 0) {
      $message = "Record Taken";
    }
    else {
      $insert = $conn->query("INSERT INTO `faculty` (faculty_name) VALUES('$faculty')");
            ...
            >
              ...
              <div> 
                ...
                <div>
                  <?php
                    if(!empty($message)) {
                      if($message == "Faculty created Successfully") {
                      ?>
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                          <td class="px-4 py-3">
                              <div class="flex items-center text-sm"> 
                                  <div>
                                      <p class="font-semibold"><?php echo $row['faculty_name'] ?></p> 
                                  </div>
                              </div>
                          </td>
