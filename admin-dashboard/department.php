<?php
  ...
  if(isset($_POST['createBtn'])) {
    ...
    $sel = $conn->query("SELECT * FROM `department` WHERE `name` = '$departmant' AND faculty = '$faculty'");
    if($sel->num_rows > 0) {
      $message = "Record Taken";
    }
    else {
      $insert = $conn->query("INSERT INTO `department` (`name`, `faculty`) VALUES('$departmant', '$faculty')");
            ...
            >
              ...
              <div> 
                ...
                <div>
                  <?php
                    if(!empty($message)) {
                      if($message == "Department created Successfully") {
                      ?>
                    ...
                    >
                        ...
                        <label class="mt-2 block text-sm">
                            ...
                            <select name="faculty" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-green-400 focus:outline-none focus:shadow-outline-green dark:text-gray-300 dark:focus:shadow-outline-gray form-input" required>
                                ...
                                <?php
                                  $select = $conn->query("SELECT * FROM faculty");
