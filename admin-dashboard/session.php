<?php
  ...
  if(isset($_POST['createBtn'])) {
    ...
    $sel = $conn->query("SELECT * FROM `session` WHERE session_name = '$session'");
    if($sel->num_rows > 0) {
      $message = "Record Taken";
    }
    else {
      $insert = $conn->query("INSERT INTO `session` (session_name) VALUES('$session')");
            ...
            >
              ...
              <div> 
                ...
                <div>
                  <?php
                    if(!empty($message)) {
                      if($message == "Session created Successfully") {
                      ?>
                ...
                <form method="post">
                    ...
                    >
                        <label class="block text-sm">
                            <span class="text-gray-700 dark:text-gray-400">Session</span>
                            <input
                            name="session"
            ...
            <!-- New Table -->
              ...
              <div> 
                ...
                <div class="w-full overflow-x-auto">
                    ...
                    >
                    <?php
                      $select = $conn->query("SELECT * FROM `session`");
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                          <td class="px-4 py-3">
                              <div class="flex items-center text-sm"> 
                                  <div>
                                      <p class="font-semibold"><?php echo $row['session_name'] ?></p> 
                                  </div>
                              </div>
                          </td>
