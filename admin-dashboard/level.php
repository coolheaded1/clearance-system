<?php
  ...
  if(isset($_POST['createBtn'])) {
    ...
    $sel = $conn->query("SELECT * FROM `level` WHERE `name` = '$level' AND department = '$departmant'");
    if($sel->num_rows > 0) {
      $message = "Record Taken";
    }
    else {
      $insert = $conn->query("INSERT INTO `level` (`name`, `department`) VALUES('$level', '$departmant')");
            ...
            >
              ...
              <div> 
                ...
                <div>
                  <?php
                    if(!empty($message)) {
                      if($message == "Level created Successfully") {
                      ?>
            ...
            <!-- New Table -->
              ...
              <div> 
                ...
                <div class="w-full overflow-x-auto">
                    ...
                    >
                      <?php
                        $select = $conn->query("SELECT * FROM `level`");
                        while($row = $select->fetch_assoc()) {
                        ?>
