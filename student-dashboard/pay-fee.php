<?php
  ...
  $sel = $conn->query("SELECT * FROM fee WHERE id = '$fee_id'");
  ...
  if(isset($_POST['payBtn'])) {
    $insert = $conn->query("INSERT INTO payment(fee_id, matric_no, fee_name, amount, student_name) VALUES('$fee_id', '$student_id', '$fee_name', '$amount', '$student_name')");
                ...
                <form method="post">
                    ...
                    >
                        <label class="block text-sm">
                            <span class="text-gray-700 dark:text-gray-400">Fee Name</span>
                            <input
